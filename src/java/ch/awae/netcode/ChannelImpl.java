...
final class ChannelImpl implements Channel {
	...
	ChannelImpl(String appId, ChannelConfiguration config, ChannelManager owner) {
		this.config = config;
		this.owner = owner;
		this.appId = appId;
	}
	...
	@Override
	public synchronized void quit(String userId) throws IOException {
	...
	@Override
	public synchronized void send(MessageImpl msg) throws IOException {
